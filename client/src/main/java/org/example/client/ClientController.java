...
public class ClientController {
    ...
    @GetMapping("/test")
    public String test(@RequestParam(defaultValue = "1000") int requestCount, @RequestParam(defaultValue = "999") int itemCount) {
        return testService.runPerformanceTest(requestCount, itemCount);
    }
}
